...
def svn_auth_open(*args):
  ...
  return _core.svn_auth_open(*args)
...
def svn_io_run_diff2(*args):
  """
    svn_io_run_diff2(char dir, int num_user_args, char label1, char label2, 
        char _from, char to, apr_file_t outfile, 
        apr_file_t errfile, char diff_cmd, apr_pool_t pool) -> svn_error_t
    """
