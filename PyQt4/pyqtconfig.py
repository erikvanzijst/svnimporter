...
_pkg_config = {
    ...
    'pyqt_config_args':  '--confirm-license -q /usr/bin/qmake-qt4 -c -j 10 LIBDIR_QT=/usr/lib STRIP= MOC=moc-qt4 LIBS_OPENGL= LIBS_X11= LIBS_THREAD= LFLAGS= CXXFLAGS_RELEASE=-g -O2 -Os LFLAGS_RELEASE=-Wl,-Bsymbolic-functions -Wl,-O1 -m /usr/lib/python2.6/config -d /usr/lib/python2.6/dist-packages',
    'pyqt_mod_dir':      '/usr/lib/python2.6/dist-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtNetwork QtOpenGL QtScript QtScriptTools QtSql QtSvg QtTest QtWebKit QtXml QtXmlPatterns phonon QtDesigner',
    'pyqt_sip_dir':      '/usr/share/sip/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_4_6_3 -x Py_v3 -g',
...
_default_macros = {
    ...
    'CFLAGS_MT_DLL':            '',
    'CFLAGS_MT_DLLDBG':         '',
    'CFLAGS_RELEASE':           '-O2 -fno-optimize-sibling-calls',
    'CFLAGS_RTTI_OFF':          '',
    'CFLAGS_RTTI_ON':           '',
    'CFLAGS_SHLIB':             '-fPIC',
    'CFLAGS_STL_OFF':           '',
    ...
    'LFLAGS_RELEASE':           '-Wl,-Bsymbolic-functions -Wl,-O1',
    'LFLAGS_SHLIB':             '-shared',
